...
JButton boton;
     ...
     */
    public VentanaCuestionario() { //inicializa el Jframe (es el constructor)
        initComponents();
        ...
        boton.addActionListener(evento->{ //evento lambda y tiene de retorno un evento
            //checar la respeusta si es falso o verdadero
            JOptionPane.showConfirmDialog(this, "Correcto");//este es el evento que esta registrado en "evento->"
        });
    }
